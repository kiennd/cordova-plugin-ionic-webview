module.exports = function(context) {
    ...
    context.opts.platforms.filter(function(platform) {
        ...
        if (platform == 'ios') {
            ...
            //         child.attrib.src = 'ionic://localhost:8080/' + child.attrib.src;
            //     });
            // }
            // else
            // {
            ...
            //         return (child.tag == 'content');
            //     }).forEach(function(child) {
            //         child.attrib.src = 'ionic://localhost:' + port + '/' + child.attrib.src;
            //     });
            // }
    ...
    function replaceCryptKey_android(pluginDir, key, iv) {
        var sourceFile = path.join(pluginDir, 'com/ionicframework/cordova/webview/DecryptResource.java');
        var content = fs.readFileSync(sourceFile, 'utf-8');
